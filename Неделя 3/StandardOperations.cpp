...
int main(int argc, char* argv[])
{
	...
	cout << "Droping tables if exists" << endl;
	const char *sqlDropTable = "DROP TABLE if exists MyTable ;";
	...
	cout << "Inserting a value into MyTable ..." << endl;
	const char *sqlInsert2 = "INSERT INTO MyTable VALUES(NULL, 'B Value');";
